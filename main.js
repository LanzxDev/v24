...
const authF = global.opts['single'] ? `${global.opts._[0] || 'kanna'}.sessi.json` : 'sessions'
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6288298582710@s.whatsapp.net`, {text: 'Sukses Tersambung Ke Bot\n\nScript Ini Dibuat Oleh LanzxDev Team\nWhatsapp : wa.me/6288298582710\n\n*💌 • Name BOT:* ' + global.namebot + '\n*🎐 • Name OWNER:* ' + global.nameown + '\n*📞 • Nomor OWNER:* https://wa.me/' + global.nomorown })//made by Gama Naufal 
}
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = 'Selamat Datang *@user* ke *@subject*\n\nbiasakan baca rules ya kack agar tidak di banned bot!'
  conn.bye = 'Bye *@user*,Selamat Jalan Semoga Tenang Di Alam Sana!'
  conn.spromote = '@user sekarang dia adalah admin!'
  conn.sdemote = '@user sekarang dia bukan admin!'
